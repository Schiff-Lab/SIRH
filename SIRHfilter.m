...
x(:,1) = (eye(4)-A)\B;      %%% initial state at equilibrium
...
ylabel('Infected','fontsize',big); 
xlabel('Time, k (days)','fontsize',big);
l=legend('Truth, I_k','Rescaled Cases, y_1/c_1','PKF','KF');
set(l,'fontsize',sml);
set(gca,'fontsize',sml);
xlim([500 1000]);
...
ylabel('Hydrocephalic','fontsize',big); 
xlabel('Time, k (days)','fontsize',big);
l=legend('Truth, H_k','Rescaled Cases, y_2/c_2','PKF','KF');
set(l,'fontsize',sml);
set(gca,'fontsize',sml);
xlim([500 1000]);
